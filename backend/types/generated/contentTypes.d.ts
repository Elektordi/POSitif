...
export interface ApiConfigConfig extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    stripe_location: Schema.Attribute.String & Schema.Attribute.Required;
    stripe_private_key: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Private;
    stripe_public_key: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::order.order'> &
      Schema.Attribute.Private;
    payment_infos: Schema.Attribute.String;
    payment_method: Schema.Attribute.String & Schema.Attribute.Required;
    payment_timestamp: Schema.Attribute.DateTime & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    refund: Schema.Attribute.Boolean & Schema.Attribute.Required;
    store: Schema.Attribute.Relation<'oneToOne', 'api::store.store'>;
...
export interface ApiPreorderPreorder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    period_end: Schema.Attribute.DateTime;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    used: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
  };
}
...
export interface ApiStoreStore extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    enable_card: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<true>;
    enable_cash: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<true>;
    enable_check: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<true>;
    enable_free: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<true>;
    enable_preorder: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    ticket_footer: Schema.Attribute.Text;
    ticket_header: Schema.Attribute.Text;
    ticket_printer_target: Schema.Attribute.String;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::preorder.preorder': ApiPreorderPreorder;
